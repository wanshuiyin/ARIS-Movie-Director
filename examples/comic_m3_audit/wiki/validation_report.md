...
> (198 nodes, 26 edges). The stdlib release gate checks: top-level required fields, node_type/status enums,
...
> Draft-2020-12 validator (jsonschema): **198/198 nodes + 26/26 edges conform**.

| check | result |
|---|---|
| total nodes | **198** |
| by type | review 111 · decision 38 · panel_attempt 37 · failure_mode 12 |
...
| generation | 24 panels · 37 attempts · 17 first-try keeps · 7 retried (S01×4, S10×4, S22×3, S03×3, S09/S13/S17×2) |
...
`image_path` is project-relative across all 198 nodes; the validator FAILS the build if any payload string
